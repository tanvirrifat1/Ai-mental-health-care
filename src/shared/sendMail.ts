            ...
            <div style="font-family: Arial, sans-serif; color: #333; padding: 20px; max-width: 600px; margin: auto;">
              <div style="background-color: #f9f9f9; border-radius: 10px; padding: 30px; border: 1px solid #e0e0e0;">
                ...
                <p style="font-size: 16px; line-height: 1.5;">
                  Thank you for choosing <strong>Internet Originals</strong>. To proceed, please use the One-Time Password (OTP) provided below:
                </p>
                ...
                <p style="font-size: 14px; margin-top: 40px;">
                  Best regards,<br/>
                  <strong>Internet Originals Team</strong>
                </p>
              </div>
              <footer style="margin-top: 20px; text-align: center; font-size: 12px; color: #aaa;">
                &copy; ${new Date().getFullYear()} Internet Originals. All rights reserved.
              </footer>
            </div>
          `,
      },
